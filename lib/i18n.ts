...
const baseEn = {
  ...
  filterDateLabel: "Date filter",
  filterDateDialogLabel: "Choose a year or month",
  ...
  waterfallLoadMore: "Load more",
  backToTop: "Back to top",
  themeLabel: "Theme",
  themeDialogLabel: "Choose a theme",
  themeAuto: "Auto",
  themeLight: "Light",
  themeDark: "Dark",
...
export const dictionaries = {
  ...
  zh: {
    ...
    filterAllYears: "全部年份",
    filterAllTime: "全部时间",
    filterDateLabel: "日期筛选",
    filterDateDialogLabel: "选择年份或月份",
    ...
    waterfallLoadMore: "加载更多",
    backToTop: "回到顶部",
    themeLabel: "主题",
    themeDialogLabel: "选择主题",
    themeAuto: "自动",
    themeLight: "亮色",
    themeDark: "暗色",
    detailBack: "返回列表",
