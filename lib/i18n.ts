...
const baseEn = {
  ...
  filterHelpSubtitle: "Mix phrases, exclusions, and field filters to narrow results quickly.",
  ...
  filterHelpExamplesHint: "Tap an example to fill the search box.",
  ...
  filterHelpTipsTitle: "Syntax guide",
  filterHelpFieldsTitle: "Field filters",
...
export const dictionaries = {
  ...
  zh: {
    ...
    filterHelpSubtitle: "组合短语、排除词和字段筛选，可以更快缩小结果范围。",
    ...
    filterHelpExamplesHint: "点击示例可直接填入搜索框。",
    ...
    filterHelpTipsTitle: "语法说明",
    filterHelpFieldsTitle: "字段筛选",
  ...
  es: {
    ...
    filterHelpSubtitle:
      "Combina frases, exclusiones y campos para acotar resultados rápidamente.",
    ...
    filterHelpExamplesHint: "Toca un ejemplo para rellenar la búsqueda.",
    ...
    filterHelpTipsTitle: "Guía de sintaxis",
    filterHelpFieldsTitle: "Filtros por campo",
  ...
  fr: {
    ...
    filterHelpSubtitle:
      "Combinez phrases, exclusions et champs pour affiner rapidement les résultats.",
    ...
    filterHelpExamplesHint: "Touchez un exemple pour remplir la recherche.",
    ...
    filterHelpTipsTitle: "Guide de syntaxe",
    filterHelpFieldsTitle: "Filtres de champ",
  ...
  de: {
    ...
    filterHelpSubtitle:
      "Kombiniere Phrasen, Ausschlüsse und Feldfilter, um Ergebnisse schneller einzugrenzen.",
    ...
    filterHelpExamplesHint: "Tippe auf ein Beispiel, um das Suchfeld zu füllen.",
    ...
    filterHelpTipsTitle: "Syntaxhilfe",
    filterHelpFieldsTitle: "Feldfilter",
  ...
  ja: {
    ...
    filterHelpSubtitle:
      "フレーズ、除外語、フィールド指定を組み合わせて、結果をすばやく絞り込めます。",
    ...
    filterHelpExamplesHint: "例をタップすると検索欄に入力されます。",
    ...
    filterHelpTipsTitle: "構文ガイド",
    filterHelpFieldsTitle: "フィールド指定",
  ...
  ko: {
    ...
    filterHelpSubtitle:
      "구문, 제외어, 필드 필터를 조합해 결과를 더 빠르게 좁힐 수 있습니다.",
    ...
    filterHelpExamplesHint: "예시를 누르면 검색창에 바로 입력됩니다.",
    ...
    filterHelpTipsTitle: "문법 안내",
    filterHelpFieldsTitle: "필드 필터",
